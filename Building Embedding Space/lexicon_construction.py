...
df = pd.read_csv(r"E:\Projects\DSI_Gihan\Datasets\HateXplain Dataset\train_processed.csv")
print(df.columns)
print(df['phrases'])
...
tokenizer = AutoTokenizer.from_pretrained("E:\Projects\DSI_Gihan\Finetuning_language_models\model")
model = AutoModel.from_pretrained(r"E:\Projects\DSI_Gihan\Finetuning_language_models\model")
...
out_df.to_csv(r"E:\Projects\DSI_Gihan\Vocabularies\vocabulary_v1.csv")